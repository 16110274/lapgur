...
<?php 
    ...
    if($_SESSION['nip']=="" ) {
     ...
     if($_SESSION['hakakses_guru']=="" ) {
                echo "as";

    }


    if($_SESSION['hakakses_guru']=="2") {
echo ("<script LANGUAGE='JavaScript'>
    window.alert('Maaf, anda tidak dapat mengakses laman ini');
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                ...
                                <ul class="collapse">
                                <li ><a href="dashgur.main.php">KBM</a></li>
                            ...
                            <li  class="active">
                                ...
                                <ul class="collapse">
                                    <li  class="active"><a href="">Nilai Keterampilan</a></li>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Nilai Keterampilan</h4>
...
if(($_GET['ta']) > 0 && !empty($_GET['smt']) > 0) {
    ...
    $nomor = 1;
        $sql = mysqli_query($koneksi,"select * from mapel_guru where id_guru=$guru");
        ...
        ?>
                     ...
                     <tr>
                                                ...
                                                <td>    <a class="edit" href="show_nk.php?id_kb=<?php echo $data['id_kb']; ?>">Lihat</a> </td>
                                            </tr>
