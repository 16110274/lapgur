            ...
            <!-- page title area end -->
                      <!-- Textual inputs start -->
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Tambah KBM</h4>


                                        <form method="post" action="dashmin.tkbm">
                                        <div class="form-group">
                                            <table >
                                                <tr>
                                                    <td>
                                                    <label for="example-text-input" class="col-form-label" style="padding-right: 20px;">Mata Pelajaran </label>
                                                    </td>
                                                    <td>
                                                    <select name="mapel" class="custome-select border-0 pr-3" >
                                                    <option hidden="">-- PILIH MAPEL --</option>
                                                          <?php echo $newkbm -> Mapel($koneksi);
                                                      ?>  
                                                    </select></td>
                                                </tr>
                                                ...
                                                <tr>
                                                <td>
                                                <label for="example-search-input" class="col-form-label">Kelas  </label></td>                                                                                  
                                                <td>
                                                <select name="kelas" class="custome-select border-0 pr-3" >                                            
                                                <option hidden="">-- PILIH KELAS --</option>
                                                      <?php echo $newkbm -> Kelasalias($koneksi);
                                                  ?>  
                                                </select></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>                                                
                                                    <label for="example-search-input" class="col-form-label">Periode  </label></td>
                                                    <td>                                             
                                                    <select name="periode" class="custome-select border-0 pr-3" >                                            
                                                    <option hidden="">-- PILIH PERIODE --</option>
                                                          <?php echo $newkbm -> periode($koneksi);
                                                      ?>  
                                                    </select></td>   
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                    <label for="example-search-input" class="col-form-label">Guru </label></td>
                                                    <td>
                                                    <select name="guru" class="custome-select border-0 pr-3" >                                            
                                                    <option hidden="">-- PILIH GURU --</option>
                                                      <?php echo $newkbm -> guru($koneksi);
                                                     ?>  
                                                    </select> </td>
                                                </tr>
                                            </table>
...
mysqli_query($koneksi,"INSERT into `kb`  (`id_mapel`, `id_guru`, `id_kelas`, `id_periode`) values ('$mapel','$guru','$kelas','$period')");
