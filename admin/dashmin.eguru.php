...
<?php
    $nomor = 1;
      $output = '';  
      $sql = "select *  from guru where id_guru=$idg"; 
...
?>
                                        ...
                                        <div class="form-group">                                            
                                            ...
                                            <input class="form-control" type="text" readonly="" value="<?php echo $row['id_guru'];  ?>" id="example-text-input">                                            
                                            <label for="example-text-input" class="col-form-label">Nama: </label>
                                            <input class="form-control" type="text" value="<?php echo $row['nama_guru'];  ?>" id="example-text-input">
