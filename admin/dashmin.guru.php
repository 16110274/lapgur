    ...
    $nomor = 1;
        ...
        ?>
                     ...
                     <tr>
                                                ...
                                                <td>
													<a class="edit" href="dashmin.eguru.php?id_guru=<?php echo $data['id_guru']; ?>">Edit</a> | 
													<a class="edit" href="dashmin.dguru.php?id_guru=<?php echo $data['id_guru']; ?>">Delete</a>
												</td>
                                            </tr>
       ...
       <?php
                ...
                <div class=" pull-right"><br>
                    <a href="dashmin.tguru"><input class="btn btn-flat btn-danger mb-3" type="reset" value="+"></a>
                </div></div></div>
            </div>  
