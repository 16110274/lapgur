...
<body>
  ...
  <?php
    ...
    if(($_GET['id_kelas']) > 0) {
        $idkel = $_GET['id_kelas'];
        $sql = mysqli_query($koneksi,"select siswa.id_siswa, siswa.nama_siswa, siswa.jk_siswa, kelas.alias_kelas
            from siswa join kelas on siswa.id_kelas = kelas.id_kelas where kelas.id_kelas='$idkel'");
    }
        ...
        ?>
                     ...
                     <tr>
                                   ...
                                   <td><?php echo $data['alias_kelas'];  ?></td>
                                                ...
                                                <td>  <a class="edit" href="dashmin.esiswa.php?id_siswa=<?php echo $data['id_siswa']; ?>"> Edit</a>


                                                </td>       <td>  <a class="edit" href="dashmin.dsiswa.php?id_siswa=<?php echo $data['id_siswa']; ?>"> Lihat</a>
       ...
       <?php
                ...
                <div class=" pull-right"><br>
                    <a href="dashmin.tsiswa"><input class="btn btn-flat btn-danger mb-3" type="reset" value="+"></a>
                </div></div></div>
            </div>  
