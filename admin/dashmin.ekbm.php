            ...
            <!-- page title area end -->
                      <!-- Textual inputs start -->
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Edit KBM</h4>
...
<?php
    $nomor = 1;
      $output = '';  
      $sql = "SELECT * from mapel_guru where id_kb=$idkbm"; 
...
?>
                                        ...
                                        <div class="form-group">
                                            <input name="idkb" class="form-control" type="text" hidden="" readonly="" value="<?php echo $row['id_kb'];  ?>" id="example-text-input">                                            
                                            ...
                                            <label for="example-search-input" class="col-form-label">Kelas : </label>
                                            <input name="kelas" class="form-control" type="text" readonly="" value="<?php echo $row['nama_kelas'];  ?>" id="example-text-input">                                            
                                            <label for="example-search-input" class="col-form-label">Tahun Ajaran : </label>
                                            <input name="tahunajar" class="form-control" type="text" readonly="" value="<?php echo $row['tahunajar'];  ?>" id="example-text-input">                                            
                                            <label for="example-search-input" class="col-form-label">Semester : </label>
                                            <input name="semester" class="form-control" type="text" readonly="" value="<?php echo $row['semester'];  ?>" id="example-text-input">
                                            <label  for="example-search-input" class="col-form-label">Guru : </label><br>
                                            <select name="guru" class="custome-select border-0 pr-3" >
                                                  <?php echo $newkbm -> gurusekarang($koneksi);
                                                  echo $newkbm -> gurulain($koneksi);
                                              ?>  
...
mysqli_query($koneksi,"UPDATE `kb` SET `id_guru`=$guru WHERE id_kb='$idkb'");
