...
if(!empty($_GET['ta']) && !empty($_GET['smt'])) {
       ...
       $smstr = $_GET['smt'];
        ...
        $sql = mysqli_query($koneksi,"select * from mapel_guru 
        where tahunajar='$thnajr'
        AND semester='$smstr'");
   ...
   if(!empty($_GET['nama_mapel'])) {

    $idmp = $_GET['nama_mapel'];
       $sql = mysqli_query($koneksi,"select * from mapel_guru where nama_mapel='$idmp'");
        ...
        ?>
                     ...
                     <tr>
                                                ...
                                                <td>    
													<a class="edit" href="dashmin.ekbm.php?id_kb=<?php echo $data['id_kb']; ?>">Edit</a> | 
													<a class="edit" href="dashmin.dkbm.php?id_kb=<?php echo $data['id_kb']; ?>">Delete</a> 
												</td>
                                            </tr>
