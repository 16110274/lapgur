                                ...
                                <ul class="collapse">
                                     ...
                                     <li>
                                        ...
                                        <ul class="collapse">
                                         ...
                                         <li class="active"><a href="dashmin.guru">Guru</a></li>
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="dashmin.tguru">
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ID Guru : </label>
                                            <input name="idguru" class="form-control" type="numeric" value="" id="example-text-input">
											...
											<input name="password" class="form-control" type="text" value="" id="example-text-input">
										
											<label for="example-search-input" class="col-form-label">Status : </label>                           
                                            <select name="state" class="custome-select border-0 pr-3" >                                             
...
mysqli_query($koneksi,"INSERT into `guru`  (`id_guru`, `nama_guru`, `status_guru`, `password`) values ('$idguru','$nama','$password','$state')");
