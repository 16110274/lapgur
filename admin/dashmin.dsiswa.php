                   ...
                   <nav>
                        <ul class="metismenu" id="menu">                            
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                     <li class="active"><a href="#">KBM</a></li>                                                                           
                                     <li>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Kegiatan Belajar Mengajar</h4>

                                 <div class="justify-content-between">
                                    <form action="dashmin.kbm" method="GET">
                                    ...
                                    ?></option>
                                    <?php echo $newkbm->tahunajar($koneksi); ?>  
                                    ...
                                    <option value="<?php if(!empty($_GET['smt'])) { echo  $_GET['smt']; }  ?>" selected="" hidden="" class="active"><?php  if(!empty($_GET['smt'])) { echo  $_GET['smt'];
                                        ...
                                        ?></option>
                                    <?php echo $newkbm->semester($koneksi); ?>  
                                    </select>
...
<?php
   ...
   if(!empty($_GET['id_siswa'])) {
    $ids = $_GET['id_siswa'];
    $nomor = 1;
        $sql = mysqli_query($koneksi,"select kb.id_kb, kbm.id_kbm from kb join kbm on kb.id_kb=kbm.id_kb where kbm.id_siswa=$ids");
        while($data = mysqli_fetch_array($sql)){
            $idkb = $data['id_kb'];
        ...
        ?>
                     ...
                     <tr>
                                   ...
                                   <?php $sqal = mysqli_query($koneksi,"select * from mapel_guru where id_kb=$idkb");
                                 while($daata = mysqli_fetch_array($sqal)){ ?>
                                   <td><?php echo $daata['nama_mapel'] ;  ?></td>
                                   <td><?php echo $daata['nama_guru'] ;  ?></td>
                                   <td><?php echo $daata['nama_kelas'] ; ?></td>
                                   <td><?php echo $daata['tahunajar'] ; ?></td>
                                   <td><?php echo $daata['semester'] ; ?></td>
                             
                                   <td><a class="edit" href="dashmin.nk.php?id_kbm=<?php echo $data['id_kbm']; ?>"> Lihat Nilai</a></td>
...
//}
                ...
                <div class=" pull-right"><br>
                    <a href="dashmin.tkbm"><input class="btn btn-flat btn-danger mb-3" type="reset" value="+"></a>
                </div>
            </div>  
