...
<?php
   ...
   if(!empty($_GET['id_kbm'])) {
    $idkbm = $_GET['id_kbm'];

    $nomor = 1;
        $sql = mysqli_query($koneksi,"select * from hitung_nk where id_kbm=$idkbm");
        while($data = mysqli_fetch_array($sql)){
       ...
       <?php
                ...
                <div class=" pull-right"><br>
                    <a href="#"><input class="btn btn-flat btn-danger mb-3" type="reset" value="+"></a>
                </div></div></div>
            </div>  
